...
pub fn create_tests() {
    ...
    custom.insert(AGENT_SKIN_ID, "yaw");
        ...
        let prop = (
            ...
            PropColumn {
                data: Some(StringVec(vec![
                    ...
                    vec![],
                    vec![],
                    vec!["knife".to_string(), "M4A4".to_string()],
                    vec!["knife_m9_bayonet".to_string(), "USP-S".to_string()],
                    vec![],
                    vec!["knife".to_string(), "USP-S".to_string()],
                    vec!["knife_tactical".to_string()],
                    vec![],
                    vec!["knife_survival_bowie".to_string()],
                    vec![],
                    vec![],
                    vec!["knife".to_string(), "USP-S".to_string()],
                    vec![],
                    ...
                    vec![],
                    vec!["knife".to_string(), "USP-S".to_string()],
                    vec!["knife_tactical".to_string(), "R8 Revolver".to_string()],
                ])),
                num_nones: 0,
            },
        );
