...
impl CDemoFileHeader {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "server_start_tick",
            |m: &CDemoFileHeader| { &m.server_start_tick },
            |m: &mut CDemoFileHeader| { &mut m.server_start_tick },
        ));
...
impl<'a> ::std::default::Default for &'a CDemoAnimationHeader {
    fn default() -> &'a CDemoAnimationHeader {
        <CDemoAnimationHeader as ::protobuf::Message>::default_instance()
    }
}
...
impl CDemoAnimationHeader {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "entity_id",
            |m: &CDemoAnimationHeader| { &m.entity_id },
            |m: &mut CDemoAnimationHeader| { &mut m.entity_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "tick",
            |m: &CDemoAnimationHeader| { &m.tick },
            |m: &mut CDemoAnimationHeader| { &mut m.tick },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "data",
            |m: &CDemoAnimationHeader| { &m.data },
            |m: &mut CDemoAnimationHeader| { &mut m.data },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<CDemoAnimationHeader>(
...
impl ::protobuf::Message for CDemoAnimationHeader {
...
impl ::protobuf::MessageFull for CDemoAnimationHeader {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CDemoAnimationHeader").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CDemoAnimationHeader {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CDemoAnimationHeader {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub struct CDemoSpawnGroups {
    ...
    pub msgs: ::std::vec::Vec<::bytes::Bytes>,
    // special fields
...
impl ::protobuf::Message for CDemoSpawnGroups {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                26 => {
                    self.msgs.push(is.read_tokio_bytes()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
pub struct CDemoRecovery {
    ...
    pub initial_spawn_group: ::protobuf::MessageField<cdemo_recovery::DemoInitialSpawnGroupEntry>,
    // @@protoc_insertion_point(field:CDemoRecovery.spawn_group_message)
    pub spawn_group_message: ::std::option::Option<::bytes::Bytes>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CDemoRecovery {
    fn default() -> &'a CDemoRecovery {
        <CDemoRecovery as ::protobuf::Message>::default_instance()
    }
}
...
impl CDemoRecovery {
    ...
    // Param is passed by value, moved
    pub fn set_spawn_group_message(&mut self, v: ::bytes::Bytes) {
        self.spawn_group_message = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_spawn_group_message(&mut self) -> &mut ::bytes::Bytes {
        if self.spawn_group_message.is_none() {
            self.spawn_group_message = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.spawn_group_message.as_mut().unwrap()
    }

    // Take field
    pub fn take_spawn_group_message(&mut self) -> ::bytes::Bytes {
        self.spawn_group_message.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }

    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        let mut fields = ::std::vec::Vec::with_capacity(2);
        let mut oneofs = ::std::vec::Vec::with_capacity(0);
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, cdemo_recovery::DemoInitialSpawnGroupEntry>(
            "initial_spawn_group",
            |m: &CDemoRecovery| { &m.initial_spawn_group },
            |m: &mut CDemoRecovery| { &mut m.initial_spawn_group },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "spawn_group_message",
            |m: &CDemoRecovery| { &m.spawn_group_message },
            |m: &mut CDemoRecovery| { &mut m.spawn_group_message },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<CDemoRecovery>(
            "CDemoRecovery",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for CDemoRecovery {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.initial_spawn_group)?;
                },
                18 => {
                    self.spawn_group_message = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CDemoRecovery {
        static instance: CDemoRecovery = CDemoRecovery {
            initial_spawn_group: ::protobuf::MessageField::none(),
...
impl ::protobuf::MessageFull for CDemoRecovery {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("CDemoRecovery").unwrap()).clone()
    }
}

impl ::std::fmt::Display for CDemoRecovery {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CDemoRecovery {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub mod cdemo_recovery {
    ...
    impl<'a> ::std::default::Default for &'a DemoInitialSpawnGroupEntry {
        fn default() -> &'a DemoInitialSpawnGroupEntry {
            <DemoInitialSpawnGroupEntry as ::protobuf::Message>::default_instance()
        }
    }
    ...
    impl DemoInitialSpawnGroupEntry {
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
                "spawngrouphandle",
                |m: &DemoInitialSpawnGroupEntry| { &m.spawngrouphandle },
                |m: &mut DemoInitialSpawnGroupEntry| { &mut m.spawngrouphandle },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
                "was_created",
                |m: &DemoInitialSpawnGroupEntry| { &m.was_created },
                |m: &mut DemoInitialSpawnGroupEntry| { &mut m.was_created },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<DemoInitialSpawnGroupEntry>(
    ...
    impl ::protobuf::Message for DemoInitialSpawnGroupEntry {
    ...
    impl ::protobuf::MessageFull for DemoInitialSpawnGroupEntry {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("CDemoRecovery.DemoInitialSpawnGroupEntry").unwrap()).clone()
        }
    }

    impl ::std::fmt::Display for DemoInitialSpawnGroupEntry {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            ::protobuf::text_format::fmt(self, f)
        }
    }

    impl ::protobuf::reflect::ProtobufValue for DemoInitialSpawnGroupEntry {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }
}
...
impl ::protobuf::EnumFull for EDemoCommands {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            EDemoCommands::DEM_AnimationHeader => 18,
            EDemoCommands::DEM_Recovery => 19,
            EDemoCommands::DEM_Max => 20,
            EDemoCommands::DEM_IsCompressed => 21,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\x05R\x08buildNum\x12\x12\n\x04game\x18\x0e\x20\x01(\tR\x04game\x12\
    *\n\x11server_start_tick\x18\x0f\x20\x01(\x05R\x0fserverStartTick\"\xec\
    \x06\n\tCGameInfo\x12,\n\x04dota\x18\x04\x20\x01(\x0b2\x18.CGameInfo.CDo\
    taGameInfoR\x04dota\x12&\n\x02cs\x18\x05\x20\x01(\x0b2\x16.CGameInfo.CCS\
    GameInfoR\x02cs\x1a\xcd\x05\n\rCDotaGameInfo\x12\x19\n\x08match_id\x18\
    \x01\x20\x01(\x04R\x07matchId\x12\x1b\n\tgame_mode\x18\x02\x20\x01(\x05R\
    \x08gameMode\x12\x1f\n\x0bgame_winner\x18\x03\x20\x01(\x05R\ngameWinner\
    \x12E\n\x0bplayer_info\x18\x04\x20\x03(\x0b2$.CGameInfo.CDotaGameInfo.CP\
    layerInfoR\nplayerInfo\x12\x1a\n\x08leagueid\x18\x05\x20\x01(\rR\x08leag\
    ueid\x12H\n\npicks_bans\x18\x06\x20\x03(\x0b2).CGameInfo.CDotaGameInfo.C\
    HeroSelectEventR\tpicksBans\x12&\n\x0fradiant_team_id\x18\x07\x20\x01(\r\
    R\rradiantTeamId\x12\x20\n\x0cdire_team_id\x18\x08\x20\x01(\rR\ndireTeam\
    Id\x12(\n\x10radiant_team_tag\x18\t\x20\x01(\tR\x0eradiantTeamTag\x12\"\
    \n\rdire_team_tag\x18\n\x20\x01(\tR\x0bdireTeamTag\x12\x19\n\x08end_time\
    \x18\x0b\x20\x01(\rR\x07endTime\x1a\xa8\x01\n\x0bCPlayerInfo\x12\x1b\n\t\
    hero_name\x18\x01\x20\x01(\tR\x08heroName\x12\x1f\n\x0bplayer_name\x18\
    \x02\x20\x01(\tR\nplayerName\x12$\n\x0eis_fake_client\x18\x03\x20\x01(\
    \x08R\x0cisFakeClient\x12\x18\n\x07steamid\x18\x04\x20\x01(\x04R\x07stea\
    mid\x12\x1b\n\tgame_team\x18\x05\x20\x01(\x05R\x08gameTeam\x1aX\n\x10CHe\
    roSelectEvent\x12\x17\n\x07is_pick\x18\x01\x20\x01(\x08R\x06isPick\x12\
    \x12\n\x04team\x18\x02\x20\x01(\rR\x04team\x12\x17\n\x07hero_id\x18\x03\
    \x20\x01(\x05R\x06heroId\x1a9\n\x0bCCSGameInfo\x12*\n\x11round_start_tic\
    ks\x18\x01\x20\x03(\x05R\x0froundStartTicks\"\xad\x01\n\rCDemoFileInfo\
    \x12#\n\rplayback_time\x18\x01\x20\x01(\x02R\x0cplaybackTime\x12%\n\x0ep\
    layback_ticks\x18\x02\x20\x01(\x05R\rplaybackTicks\x12'\n\x0fplayback_fr\
    ames\x18\x03\x20\x01(\x05R\x0eplaybackFrames\x12'\n\tgame_info\x18\x04\
    ...
    backs\x12\x17\n\x07save_id\x18\x01\x20\x03(\tR\x06saveId\"[\n\x14CDemoAn\
    imationHeader\x12\x1b\n\tentity_id\x18\x01\x20\x01(\x11R\x08entityId\x12\
    \x12\n\x04tick\x18\x02\x20\x01(\x05R\x04tick\x12\x12\n\x04data\x18\x03\
    \x20\x01(\x0cR\x04data\"\xa4\x01\n\x12CDemoAnimationData\x12\x1b\n\tenti\
    ty_id\x18\x01\x20\x01(\x11R\x08entityId\x12\x1d\n\nstart_tick\x18\x02\
    \x20\x01(\x05R\tstartTick\x12\x19\n\x08end_tick\x18\x03\x20\x01(\x05R\
    \x07endTick\x12\x12\n\x04data\x18\x04\x20\x01(\x0cR\x04data\x12#\n\rdata\
    _checksum\x18\x05\x20\x01(\x03R\x0cdataChecksum\"\xbd\x02\n\x11CDemoStri\
    ngTables\x122\n\x06tables\x18\x01\x20\x03(\x0b2\x1a.CDemoStringTables.ta\
    ble_tR\x06tables\x1a/\n\x07items_t\x12\x10\n\x03str\x18\x01\x20\x01(\tR\
    \x03str\x12\x12\n\x04data\x18\x02\x20\x01(\x0cR\x04data\x1a\xc2\x01\n\
    \x07table_t\x12\x1d\n\ntable_name\x18\x01\x20\x01(\tR\ttableName\x120\n\
    \x05items\x18\x02\x20\x03(\x0b2\x1a.CDemoStringTables.items_tR\x05items\
    \x12E\n\x10items_clientside\x18\x03\x20\x03(\x0b2\x1a.CDemoStringTables.\
    items_tR\x0fitemsClientside\x12\x1f\n\x0btable_flags\x18\x04\x20\x01(\
    \x05R\ntableFlags\"\x0b\n\tCDemoStop\"A\n\x0cCDemoUserCmd\x12\x1d\n\ncmd\
    _number\x18\x01\x20\x01(\x05R\tcmdNumber\x12\x12\n\x04data\x18\x02\x20\
    \x01(\x0cR\x04data\"&\n\x10CDemoSpawnGroups\x12\x12\n\x04msgs\x18\x03\
    \x20\x03(\x0cR\x04msgs\"\x85\x02\n\rCDemoRecovery\x12Y\n\x13initial_spaw\
    n_group\x18\x01\x20\x01(\x0b2).CDemoRecovery.DemoInitialSpawnGroupEntryR\
    \x11initialSpawnGroup\x12.\n\x13spawn_group_message\x18\x02\x20\x01(\x0c\
    R\x11spawnGroupMessage\x1ai\n\x1aDemoInitialSpawnGroupEntry\x12*\n\x10sp\
    awngrouphandle\x18\x01\x20\x01(\rR\x10spawngrouphandle\x12\x1f\n\x0bwas_\
    created\x18\x02\x20\x01(\x08R\nwasCreated*\xc6\x03\n\rEDemoCommands\x12\
    \x16\n\tDEM_Error\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x0c\n\
    \x08DEM_Stop\x10\0\x12\x12\n\x0eDEM_FileHeader\x10\x01\x12\x10\n\x0cDEM_\
    FileInfo\x10\x02\x12\x10\n\x0cDEM_SyncTick\x10\x03\x12\x12\n\x0eDEM_Send\
    Tables\x10\x04\x12\x11\n\rDEM_ClassInfo\x10\x05\x12\x14\n\x10DEM_StringT\
    ables\x10\x06\x12\x0e\n\nDEM_Packet\x10\x07\x12\x14\n\x10DEM_SignonPacke\
    t\x10\x08\x12\x12\n\x0eDEM_ConsoleCmd\x10\t\x12\x12\n\x0eDEM_CustomData\
    \x10\n\x12\x1b\n\x17DEM_CustomDataCallbacks\x10\x0b\x12\x0f\n\x0bDEM_Use\
    rCmd\x10\x0c\x12\x12\n\x0eDEM_FullPacket\x10\r\x12\x10\n\x0cDEM_SaveGame\
    \x10\x0e\x12\x13\n\x0fDEM_SpawnGroups\x10\x0f\x12\x15\n\x11DEM_Animation\
    Data\x10\x10\x12\x17\n\x13DEM_AnimationHeader\x10\x11\x12\x10\n\x0cDEM_R\
    ecovery\x10\x12\x12\x0b\n\x07DEM_Max\x10\x13\x12\x14\n\x10DEM_IsCompress\
    ed\x10@\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(CDemoAnimationHeader::generated_message_descriptor_data());
            ...
            messages.push(CDemoRecovery::generated_message_descriptor_data());
            ...
            messages.push(cdemo_recovery::DemoInitialSpawnGroupEntry::generated_message_descriptor_data());
