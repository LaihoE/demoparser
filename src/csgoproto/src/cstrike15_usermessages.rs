...
impl ::protobuf::Enum for ECstrike15UserMessages {
    ...
    fn from_str(str: &str) -> ::std::option::Option<ECstrike15UserMessages> {
        match str {
            ...
            "CS_UM_UtilMsg" => ::std::option::Option::Some(ECstrike15UserMessages::CS_UM_UtilMsg),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xfc\x02\x12\x14\n\x0fCS_UM_DeepStats\x10\xfd\x02\x12\x12\n\rCS_UM_UtilM\
    sg\x10\xfe\x02\x12\x14\n\x0fCS_UM_ShootInfo\x10\xff\x02*\x88\x01\n\"ECSU\
    srMsg_DisconnectToLobby_Action\x120\n,k_ECSUsrMsg_DisconnectToLobby_Acti\
    on_Default\x10\0\x120\n,k_ECSUsrMsg_DisconnectToLobby_Action_GoQueue\x10\
    \x01\
";
