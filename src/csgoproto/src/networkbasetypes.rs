...
impl CNETMsg_Tick {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "legacy_host_loss",
            |m: &CNETMsg_Tick| { &m.legacy_host_loss },
            |m: &mut CNETMsg_Tick| { &mut m.legacy_host_loss },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            ...
            |m: &CNETMsg_Tick| { &m.host_frame_dropped_pct_x10 },
            |m: &mut CNETMsg_Tick| { &mut m.host_frame_dropped_pct_x10 },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "host_frame_irregular_arrival_pct_x10",
            |m: &CNETMsg_Tick| { &m.host_frame_irregular_arrival_pct_x10 },
            |m: &mut CNETMsg_Tick| { &mut m.host_frame_irregular_arrival_pct_x10 },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\n\x04slot\x18\x01\x20\x01(\x05R\x04slot\"\xa8\x04\n\x0cCNETMsg_Tick\
    \x12\x12\n\x04tick\x18\x01\x20\x01(\rR\x04tick\x121\n\x14host_computatio\
    ntime\x18\x04\x20\x01(\rR\x13hostComputationtime\x12K\n\"host_computatio\
    ntime_std_deviation\x18\x05\x20\x01(\rR\x1fhostComputationtimeStdDeviati\
    on\x12(\n\x10legacy_host_loss\x18\x07\x20\x01(\rR\x0elegacyHostLoss\x12:\
    \n\x19host_unfiltered_frametime\x18\x08\x20\x01(\rR\x17hostUnfilteredFra\
    metime\x12*\n\x11hltv_replay_flags\x18\t\x20\x01(\rR\x0fhltvReplayFlags\
    \x12,\n\x12expected_long_tick\x18\n\x20\x01(\rR\x10expectedLongTick\x129\
    \n\x19expected_long_tick_reason\x18\x0b\x20\x01(\tR\x16expectedLongTickR\
    eason\x12:\n\x1ahost_frame_dropped_pct_x10\x18\x0c\x20\x01(\rR\x16hostFr\
    ameDroppedPctX10\x12M\n$host_frame_irregular_arrival_pct_x10\x18\r\x20\
    \x01(\rR\x1fhostFrameIrregularArrivalPctX10\"V\n\x11CNETMsg_StringCmd\
    \x12\x18\n\x07command\x18\x01\x20\x01(\tR\x07command\x12'\n\x0fpredictio\
    n_sync\x18\x02\x20\x01(\rR\x0epredictionSync\":\n\x11CNETMsg_SetConVar\
    \x12%\n\x07convars\x18\x01\x20\x01(\x0b2\x0b.CMsg_CVarsR\x07convars\"\
    \x8b\x02\n\x13CNETMsg_SignonState\x12C\n\x0csignon_state\x18\x01\x20\x01\
    (\x0e2\x0e.SignonState_t:\x10SIGNONSTATE_NONER\x0bsignonState\x12\x1f\n\
    \x0bspawn_count\x18\x02\x20\x01(\rR\nspawnCount\x12,\n\x12num_server_pla\
    yers\x18\x03\x20\x01(\rR\x10numServerPlayers\x12-\n\x12players_networkid\
    s\x18\x04\x20\x03(\tR\x11playersNetworkids\x12\x19\n\x08map_name\x18\x05\
    \x20\x01(\tR\x07mapName\x12\x16\n\x06addons\x18\x06\x20\x01(\tR\x06addon\
    s\"\xe1\x02\n\x11CSVCMsg_GameEvent\x12\x1d\n\nevent_name\x18\x01\x20\x01\
    (\tR\teventName\x12\x18\n\x07eventid\x18\x02\x20\x01(\x05R\x07eventid\
    \x12,\n\x04keys\x18\x03\x20\x03(\x0b2\x18.CSVCMsg_GameEvent.key_tR\x04ke\
    ys\x1a\xe4\x01\n\x05key_t\x12\x12\n\x04type\x18\x01\x20\x01(\x05R\x04typ\
    e\x12\x1d\n\nval_string\x18\x02\x20\x01(\tR\tvalString\x12\x1b\n\tval_fl\
    oat\x18\x03\x20\x01(\x02R\x08valFloat\x12\x19\n\x08val_long\x18\x04\x20\
    ...
    \x15net_Disconnect_Legacy\x10\x01\x12\x17\n\x13net_SplitScreenUser\x10\
    \x03\x12\x0c\n\x08net_Tick\x10\x04\x12\x11\n\rnet_StringCmd\x10\x05\x12\
    \x11\n\rnet_SetConVar\x10\x06\x12\x13\n\x0fnet_SignonState\x10\x07\x12\
    \x17\n\x13net_SpawnGroup_Load\x10\x08\x12!\n\x1dnet_SpawnGroup_ManifestU\
    pdate\x10\t\x12\"\n\x1enet_SpawnGroup_SetCreationTick\x10\x0b\x12\x19\n\
    \x15net_SpawnGroup_Unload\x10\x0c\x12\x20\n\x1cnet_SpawnGroup_LoadComple\
    ted\x10\r\x12\x14\n\x10net_DebugOverlay\x10\x0f*\xcc\x02\n\x11SpawnGroup\
    Flags_t\x12'\n#SPAWN_GROUP_LOAD_ENTITIES_FROM_SAVE\x10\x01\x12#\n\x1fSPA\
    WN_GROUP_DONT_SPAWN_ENTITIES\x10\x02\x12!\n\x1dSPAWN_GROUP_SYNCHRONOUS_S\
    PAWN\x10\x04\x12&\n\"SPAWN_GROUP_IS_INITIAL_SPAWN_GROUP\x10\x08\x12+\n'S\
    PAWN_GROUP_CREATE_CLIENT_ONLY_ENTITIES\x10\x10\x12\"\n\x1eSPAWN_GROUP_BL\
    OCK_UNTIL_LOADED\x10@\x12$\n\x1fSPAWN_GROUP_LOAD_STREAMING_DATA\x10\x80\
