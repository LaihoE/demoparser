...
pub struct CP2P_TextMessage {
    ...
    pub text: ::std::option::Option<::bytes::Bytes>,
    // special fields
...
impl CP2P_TextMessage {
    ...
    pub fn set_text(&mut self, v: ::bytes::Bytes) {
        self.text = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_text(&mut self) -> &mut ::bytes::Bytes {
        if self.text.is_none() {
            self.text = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.text.as_mut().unwrap()
    }

    // Take field
    pub fn take_text(&mut self) -> ::bytes::Bytes {
        self.text.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
...
impl ::protobuf::Message for CP2P_TextMessage {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.text = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                tag => {
